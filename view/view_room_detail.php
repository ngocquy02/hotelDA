...
<link href="<?php echo $option['link'];?>/admin/css/system.css" rel="stylesheet">
...
<link href="<?php echo $option['link'];?>/admin/css/datepicker.css" rel="stylesheet" />
<script src="<?php echo $option['link'];?>/admin/js/jquery-1.12.4.min.js"></script>
<script src="<?php echo $option['link'];?>/admin/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php echo $option['link'];?>/admin/js/bootstrap-datepicker.js"></script>
...
<script>
    ...
    <script src="<?php echo $option['link'];?>/admin/js/typed.js" type="text/javascript"></script>
    <script>
    $(function(){
			...
			<div class="col col-sm-4 room">
				<article class="room_detail" style="min-height: 403px;">
					<div class="item-image">
						<img itemprop="thumbnailUrl" alt="" src="<?php echo $option['link'];?>/admin/images/room/<?php echo $rooms['img'];?>">
					</div>
