...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2016 at 11:03 PM
...
--
-- Table structure for table `sort_of_room`
--

CREATE TABLE `sort_of_room` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users_admin` (`id`, `adress`, `birth_day`, `citys`, `email`, `gender_id`, `level_id`, `name`, `passport`, `password`, `phone`, `employee_number`) VALUES
...
--
-- Indexes for table `sort_of_room`
--
ALTER TABLE `sort_of_room`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `sort_of_room`
--
ALTER TABLE `sort_of_room`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `customer`
  ...
  ADD CONSTRAINT `customer_ibfk_2` FOREIGN KEY (`citys`) REFERENCES `citys` (`id`);
...
ALTER TABLE `room`
  ...
  ADD CONSTRAINT `room_ibfk_3` FOREIGN KEY (`sort_of_room_id`) REFERENCES `sort_of_room` (`id`);

--
-- Constraints for table `users_admin`
--
ALTER TABLE `users_admin`
  ADD CONSTRAINT `city` FOREIGN KEY (`citys`) REFERENCES `citys` (`id`),
