<?php
    ...
    add_room_order_search($_GET['room_id'],$date_check_in,$date_checkout,$date_order,$get_customer['id'],$price,$date);
    header ("Location: /hotelDA/model/send_mail_room_order.php");
  ?>
