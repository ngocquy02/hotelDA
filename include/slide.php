    ...
    <style>
        ...
        */
        ...
        .jssort01 .c {
            ...
            background: url('img/t01.png') -760px -760px no-repeat;
            _background: none;
        }
    ...
    <div class="col-md-8" id="jssor_1" style="position: relative; margin-bottom: 30px; top: 0px; left: 0px; width: 760px; height: 456px; overflow: hidden; visibility: hidden; background-color: #24262e;">
        ...
        <!-- Thumbnail Navigator -->
        <div data-u="thumbnavigator" class="jssort01" style="position:absolute;left:0px;bottom:0px;width:760px;height:100px;" data-autocenter="1">
