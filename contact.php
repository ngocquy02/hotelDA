...
<div class="container wrapper-body" style=" width : 100% ; margin: auto;" >
	...
	<h2 class="text-success list_room_title" style="text-align:center; margin:20px 0px;">LIÊN HỆ</h2>
	<div class="col-md-12" style="padding: 0px; margin:0px;">
        ...
        <div class="form-group">
			...
			<textarea class="form-control" id="4" required name="email" style="height:150px;"></textarea>
        </div>
       
		<button id="button" onclick="return true;"  type="submit" class="btn btn-primary">Gửi
		</button>
	</div>								
	<iframe class="col-md-12" src="https://www.google.com/maps/d/embed?mid=1-KjZNYslWab9NDLm9fhR00hvwkw" style="height:420px;margin:30px;"></iframe>	
	</div>
</div>
